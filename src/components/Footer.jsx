...
const Footer = () => {
  return (
    <footer className="footer bg-rose-100 bg-opacity-60 backdrop-blur-lg shadow-lg border border-opacity-30 border-white text-white py-4 w-full -mb-6  z-10 animate-fade-in dark:bg-gray-800">
